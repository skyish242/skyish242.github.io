...
type LayoutRouteId = RouteId | "/(blog-article)/blog-posts" | "/(blog-article)/customization" | "/(blog-article)/project-structure"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(blog-article)/+layout.server.js').load>>>>>>;
